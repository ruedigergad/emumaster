...
#ifdef _ASM_CD_MEMORY_C
extern "C" u32 PicoReadM68k8(u32 a);
#else
...
#ifdef _ASM_CD_MEMORY_C
extern "C" u32 PicoReadM68k16(u32 a);
#else
...
#ifdef _ASM_CD_MEMORY_C
extern "C" u32 PicoReadM68k32(u32 a);
#else
...
#ifdef _ASM_CD_MEMORY_C
extern "C" void PicoWriteM68k8(u32 a,u8 d);
#else
...
#ifdef _ASM_CD_MEMORY_C
extern "C" void PicoWriteM68k16(u32 a,u16 d);
#else
...
#ifdef _ASM_CD_MEMORY_C
extern "C" void PicoWriteM68k32(u32 a,u32 d);
#else
...
#ifdef _ASM_CD_MEMORY_C
extern "C" u32 PicoReadS68k8(u32 a);
#else
...
#ifdef _ASM_CD_MEMORY_C
extern "C" u32 PicoReadS68k16(u32 a);
#else
...
#ifdef _ASM_CD_MEMORY_C
extern "C" u32 PicoReadS68k32(u32 a);
#else
...
#ifdef _ASM_CD_MEMORY_C
extern "C" void PicoWriteS68k8(u32 a,u8 d);
#else
...
#ifdef _ASM_CD_MEMORY_C
extern "C" void PicoWriteS68k16(u32 a,u16 d);
#else
...
#ifdef _ASM_CD_MEMORY_C
extern "C" void PicoWriteS68k32(u32 a,u32 d);
#else
