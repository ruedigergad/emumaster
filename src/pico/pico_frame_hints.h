...
static int PicoFrameHints(void)
{
  ...
  if (Pico.m.pal) {
    //cycles_68k = (int) ((qreal) OSC_PAL  /  7 / 50 / 312 + 0.4); // should compile to a constant (488)
    //cycles_z80 = (int) ((qreal) OSC_PAL  / 15 / 50 / 312 + 0.4); // 228
    line_sample = 68;
    if(pv->reg[1]&8) lines_vis = 240;
  } else {
    //cycles_68k = (int) ((qreal) OSC_NTSC /  7 / 60 / 262 + 0.4); // 488
    //cycles_z80 = (int) ((qreal) OSC_NTSC / 15 / 60 / 262 + 0.4); // 228
    line_sample = 93;
  }
