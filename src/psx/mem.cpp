...
bool psxMemInit() {
  ...
  psxM = (s8 *)mmap((void *)0x80000000, 0x00220000, PROT_WRITE | PROT_READ, MAP_FIXED | MAP_PRIVATE | MAP_ANONYMOUS, -1, 0);

	psxP = &psxM[0x200000];
	psxH = &psxM[0x210000];

	psxR = (s8 *)mmap((void *)0x9fc00000, 0x80000, PROT_WRITE | PROT_READ, MAP_FIXED | MAP_PRIVATE | MAP_ANONYMOUS, -1, 0);
